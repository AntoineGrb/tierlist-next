...
const TierList = () => {
    ...
    const items = [ 
        { id: '1', name: 'javascript', src:'/assets/test/langages/javascript.png' },
        { id: '2', name: 'javascript', src:'/assets/test/langages/javascript.png' },
        { id: '3', name: 'javascript', src:'/assets/test/langages/javascript.png' },
    ]
