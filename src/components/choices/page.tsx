...
const Choices = ({items, isMobile}: ChoicesProps) => {
    ...
    return (
        ...
        <Droppable droppableId='choices' direction='horizontal'>
            {(provided) => (
                <div ref={provided.innerRef} {...provided.droppableProps} className='fixed bottom-0 w-full min-h-3 flex-wrap bg-gray-200 shadow-md overflow-x-scroll flex justify-start items-center gap-1 p-2 rounded-lg sm:relative sm:mt-1 sm:overflow-x-auto'>
